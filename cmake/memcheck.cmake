...
if(WITH_MEMCHECK)
  ...
  if(NOT TARGET memcheck)
    ...
    add_custom_target(
      memcheck
      COMMAND ${MEMCHECK_REPORTER}/generate_html_report.sh -i ${MEMCHECK_REPORT}
              -o ${MEMCHECK_REPORT}
...
function(add_memcheck target)
  if(WITH_MEMCHECK)
    add_custom_target(
      memcheck-${target}
      COMMAND ${MEMCHECK_REPORTER}/memcheck_runner.sh -o
              ${MEMCHECK_REPORT}/${target} -- $<TARGET_FILE:${target}>
      WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
